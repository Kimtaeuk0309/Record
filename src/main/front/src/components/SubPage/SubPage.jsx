...
function getCurrentQuarterRange() {
  ...
  const quarter = Math.floor(month / 3) + 1; // 1~4 분기
  return { year, quarter };
}
...
const WallRecordSystem = () => {
  ...
  return (
      ...
      <div className="container" style={{ maxWidth: 950, marginTop: 30, marginLeft: 50, marginRight: 'auto' }}>
        <h2>테이블 정보</h2>
        <table id="statsTable">
          <thead>
            <tr>
